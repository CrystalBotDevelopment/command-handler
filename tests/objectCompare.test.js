...
const objectCompare_1 = require("../src/functions/objectCompare");
describe('Checking if object compare properly compares the commands with the database', () => {
    describe('Testing values', () => {
        test.each([
            ...
            if (b == 'undefined')
                b = undefined;
            expect((0, objectCompare_1.compare)(a, b)).toBe(expected);
        });
        test.each([
            [{ a: 1 }, { a: 1 }, true],
            [{ a: 1 }, { a: 2 }, false],
            ...
            expect((0, objectCompare_1.objectCompare)(a, b)).toBe(expected);
        });
    });
